                                    ...
                                    <div className="flex flex-col items-start justify-start gap-2">
                                        ...
                                        <div className="relative flex items-center justify-start gap-1">
                                            ...
                                            >
                                                ...
                                                <defs>
                                                    <clippath id="clip0_86_4600">
                                                        <rect width={8} height={12} fill="white" transform="translate(0.331787 0.493042)" />
                                                    </clippath>
                                                </defs>
                                            </svg>
                                            <div className="relative flex items-center justify-start gap-1">
                                    ...
                                    <div className="flex flex-col items-start justify-start gap-2">
                                        <div className="relative flex items-center justify-start gap-1">
                                            ...
                                            >
                                                ...
                                                <defs>
                                                    <clippath id="clip0_86_4633">
                                                        <rect width={12} height={12} fill="white" transform="translate(0.526855 0.991943)" />
                                                    </clippath>
                                                </defs>
                                            </svg>
                                        </div>
                                        ...
                                        <div className="relative flex items-center justify-center gap-1">
                                            ...
                                            >
                                                ...
                                                <defs>
                                                    <clippath id="clip0_86_4637">
                                                        <rect width={8} height={12} fill="white" transform="translate(0.526855 0.491943)" />
                                                    </clippath>
                                                </defs>
                                            </svg>
