        ...
        <>
            ...
            <div className="container">
                <div className="flex items-stretch gap-6 mt-8">
                    <div className="w-[calc(66.66%-24px)]">
                            ...
                            <div className="flex items-center gap-6 mb-8">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <defs>
                                            <clippath id="clip0_86_1144">
                                                <rect width={19} height={19} fill="white" transform="translate(0.219238 0.863525)" />
                                            </clippath>
                                        </defs>
                                    </svg>
                                </div>
                    ...
                    <div className="w-[calc(33.33%-24px)]">
                ...
                <div className="flex items-stretch gap-6 mt-6 mb-8">
                    <div className="w-[calc(66.66%-24px)]">
