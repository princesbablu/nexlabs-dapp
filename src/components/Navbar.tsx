...
const Navbar = () => {
    ...
    return (
        <>
            <div className={`fixed top-0 left-0 h-full w-full bg-black/50 z-50 lg:invisible ${toggleNav ? 'visible' : 'invisible'}`} onClick={() => setToggleNav(!toggleNav)}></div>
            <div className="relative z-50">
                <div className="container">
                    <div className="flex items-center h-20 gap-8">
                        ...
                        <div className={`fixed top-0 transition-all duration-300 left-0 h-full bg-body w-72 sm:w-80 lg:static lg:top-auto lg:left-auto lg:h-auto lg:w-auto  lg:-translate-x-0 ${toggleNav ? '' : '-translate-x-full'} z-[80]`}>
                                    ...
                                    <ul className="lg:absolute left-0 top-full mx-2 lg:w-[380px] rounded-xl bg-[#151B10] lg:px-4 py-1 lg:opacity-0 lg:invisible group-hover:opacity-100 group-hover:visible group-hover:mt-0 lg:mt-1 transition-all z-10">
                                        ...
                                        <li className="relative border-b border-[#69765D]/10 last:border-0">
                                            <Link href="/trade" className="flex items-center gap-3 px-5 py-3 text-white hover:text-[#6DAC4C] opacity-80 group">
                                                <span>
                                                    <Image src="/nav-icon-1.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '22px' }} />
                                                </span>
                                                <span className="block w-full">
                                                    Perpetual - Individual Assets
                                                </span>
                                                <span className="ml-auto">
                                                    <Image src="/nav-angle-right.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '8px' }} />
                                                </span>
                                            </Link>
                                        </li>
                                        <li className="relative border-b border-[#69765D]/10 last:border-0">
                                            <Link href="/trade" className="flex items-center gap-3 px-5 py-3 text-white hover:text-[#6DAC4C] opacity-80 group">
                                                <span>
                                                    <Image src="/nav-icon-2.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '22px' }} />
                                                </span>
                                                <span className="block w-full">
                                                    Perpetual - Indices
                                                </span>
                                        ...
                                        <li className="relative border-b border-[#69765D]/10 last:border-0">
                                            <Link href="/trade" className="flex items-center gap-3 px-5 py-3 text-white hover:text-[#6DAC4C] opacity-80 group">
                                                <span>
                                                    <Image src="/nav-icon-3.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '22px' }} />
                                                </span>
                                                <span className="block w-full">
                        ...
                        <div className="flex items-center gap-3 ml-auto">
                                ...
                                <ul className="absolute right-0 top-full w-[110px] rounded-xl bg-[#151B10] px-4 py-2.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:mt-2 mt-3 transition-all z-10 flex flex-col gap-2.5">
                                    ...
                                    <li className="flex gap-2.5">
                                        <div className="flex-shrink-0">
                                            <Image src="/coin-usdc.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '16px' }} />
                                        </div>
                                        <p className="text-sm font-medium text-left text-[#f6f9f3]">USD</p>
                                    </li>
                                    <li className="flex gap-2.5">
                                        <div className="flex-shrink-0">
                                            <Image src="/coin-eth.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '16px' }} />
                                        </div>
                                        <p className="text-sm font-medium text-left text-[#f6f9f3]">ETH</p>
                                    </li>
                                    <li className="flex gap-2.5">
                                        <div className="flex-shrink-0">
                                            <Image src="/coin-bit.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '16px' }} />
                                        </div>
                            ...
                            <div className="bg-gradient-to-tl from-[#00ADEF] to-[#8AC640] p-px rounded-lg cursor-pointer hover:from-[#8ac640] hover:to-[#00adef] group shrink-0">
                                <div className="relative flex items-center justify-center gap-3 px-3 rounded-lg h-9 sm:h-11 bg-body sm:px-4">
                                    <Image src="/currency-logo.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '22px' }} className='w-4 h-4 sm:h-6 sm:w-6' />
                                        ...
                                        <li className="flex flex-col gap-2 py-2 border-b border-[#69765D]/20">
                                            <div className="flex justify-between items-center px-2 group/link hover:bg-[#12160E]">
                                                <div className="relative flex items-center justify-start gap-2">
                                                    <Image src="/currency-logo.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '22px' }} />
                                            ...
                                            <div className="flex justify-between items-center px-2 group/link hover:bg-[#12160E]">
                                                <div className="relative flex items-center justify-start gap-2">
                                                    <Image src="/currency-logo-2.png" alt="" width={0} height={0} sizes="100vw" style={{ width: 'auto', height: 'auto', minWidth: '22px' }} />
